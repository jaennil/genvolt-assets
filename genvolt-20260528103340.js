/* Genvolt external Tilda bundle. Built 2026-05-28T10:33:40.787Z. */
(function(){
  var VERSION="20260528103340";
    ...
    (function () {
      ...
      function buildSearch(values, recId) {
        ...
        if (!hasExplicitFuel) {
          ...
          fuelValues.forEach(function (value) {
            if (fuelParamName) search.append(fuelParamName, value);
          });
        }
