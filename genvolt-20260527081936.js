/* Genvolt external Tilda bundle. Built 2026-05-27T08:19:36.617Z. */
(function(){
  var VERSION="20260527081936";
  ...
  (function(){
    (function () {
      ...
      if (!params.has('gv_preact_filters')) return;
      ...
      function withPreactFlag(search) {
        var params = new URLSearchParams((search || '').replace(/^\?/, ''));
        params.set('gv_preact_filters', '1');
          ...
          function submit() {
            ...
            setTimeout(function () {
              if (!isGeneratorCatalogPage()) {
                location.href = '/catalog/generators' + withPreactFlag(buildSearch(values, GENERATOR_REC_ID));
                return;
              }
              location.href = location.pathname + withPreactFlag(buildSearch(values, recId()));
            }, 350);
          }
    
          function reset() {
            clearNative();
            setValues(initialState(props.model));
          }
