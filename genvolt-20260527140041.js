/* Genvolt external Tilda bundle. Built 2026-05-27T14:00:41.758Z. */
(function(){
  var VERSION="20260527140041";
          ...
          function submit() {
            ...
            setTimeout(function () {
              if (!isGeneratorCatalogPage()) {
                location.href = '/catalog/generators' + normalizeSearch(buildSearch(values, GENERATOR_REC_ID));
                return;
              }
              location.href = location.pathname + normalizeSearch(buildSearch(values, recId()));
            }, 350);
          }
